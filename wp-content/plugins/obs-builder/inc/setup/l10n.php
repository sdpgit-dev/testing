 ...
 * @since 1.0.0.
 */
final class OBSPGB_Setup_L10n implements OBSPGB_Setup_L10nInterface, OBSPGB_Util_HookInterface {
	/**
	 ...
	 * and the child text domain, the file names should be prefixed with the domain, e.g. obspgb-en_US.mo
	 *
