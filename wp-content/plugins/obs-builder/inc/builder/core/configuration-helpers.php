...
if ( ! function_exists( 'ttfobspgb_create_config_select' ) ) :
/**
 ...
 */
function ttfobspgb_create_config_select( $section_name, $args, $section_data ) {
	$return        = '';
	$current_value = ttfobspgb_get_current_configuration_value( $section_data, $args );
	...
	if ( isset( $args['default'] ) && isset( $args['options'] ) ) {
		...
		$description = ( isset( $args['description'] ) ) ? '<div class="ttfobspgb-configuration-description">' . esc_html( $args['description'] ) . '</div>': '';
...
if ( ! function_exists( 'ttfobspgb_create_config_checkbox' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_config_checkbox( $section_name, $args, $section_data ) {
	$current_value = ttfobspgb_get_current_configuration_value( $section_data, $args );
	...
	$description = ( isset( $args['description'] ) ) ? '<div class="ttfobspgb-configuration-description">' . esc_html( $args['description'] ) . '</div>': '';
	$args        = '<input id="' . $id . '" type="checkbox" name="' . $id . '" value="1" data-model-attr="' . $args['name'] .'" {{ (parseInt(get("'. $args['name' ] .'"), 10) === 1) ? " checked": "" }}' . ( $disabled ? 'disabled="disabled"': '' ) . '>' . $description;

	return  $label . $args;
}
endif;

if ( ! function_exists( 'ttfobspgb_create_config_text' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_config_text( $section_name, $args, $section_data ) {
	$current_value = ttfobspgb_get_current_configuration_value( $section_data, $args );
	$id          = $section_name . '[' . esc_attr( $args['name'] ) . ']';
	$label       = ( isset( $args['label'] ) ) ? '<label for="' . $id . '">' . esc_html( $args['label'] ) . '</label>' : '';
...
if ( ! function_exists( 'ttfobspgb_create_config_image' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_config_image( $section_name, $args, $section_data ) {
	$current_value = ttfobspgb_get_current_configuration_value( $section_data, $args );
	...
	return $label . ttfobspgb_get_builder_base()->add_uploader( $name, $current_value, __( 'Set image', 'obspgb' ) );
}
endif;

if ( ! function_exists( 'ttfobspgb_create_config_color' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_config_color( $section_name, $args, $section_data ) {
	$current_value = ttfobspgb_get_current_configuration_value( $section_data, $args );
	$name        = $section_name . '[' . esc_attr( $args['name'] ) . ']';
	$label       = ( isset( $args['label'] ) ) ? '<label for="' . $name . '">' . esc_html( $args['label'] ) . '</label>' : '';
	$class       = ( isset( $args['class'] ) ) ? ' class="' . esc_attr( $args['class'] ) . '"' : '';
...
if ( ! function_exists( 'ttfobspgb_create_config_section_title' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_config_section_title( $section_name, $args, $section_data ) {
	$current_value = ttfobspgb_get_current_configuration_value( $section_data, $args );
	...
	return  '<input' . $placeholder . ' type="text" ' . $name . ' value="' . esc_attr( $current_value ) . '" class="ttfobspgb-title' . $class . '" data-model-attr="' . $args['name'] . '" autocomplete="off">';
}
endif;

if ( ! function_exists( 'ttfobspgb_create_config_divider' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_config_divider( $section_name, $args, $section_data ) {
...
if ( ! function_exists( 'ttfobspgb_get_current_configuration_value' ) ) :
/**
 ...
 */
function ttfobspgb_get_current_configuration_value( $section_data, $args ) {
...
if ( ! function_exists( 'ttfobspgb_create_input' ) ) :
/**
 ...
 * @return string                     The full input string.
 */
function ttfobspgb_create_input( $section_name, $args, $section_data ) {
	$final_output = '';

	if ( isset( $args['type'] ) ) {
		// Get the input HTML
		$function_name = 'ttfobspgb_create_config_' . $args['type'];
		...
		if ( is_callable( $function_name ) ) {
			 ...
			 */
			$wrap = apply_filters( 'obspgb_configuration_overlay_input_wrap', '<div class="ttfobspgb-configuration-overlay-input-wrap %1$s">%2$s</div>', $args, $section_data );
			 ...
			 * @param string    $section_data    The data for the section.
			 */
			$input_html = apply_filters( 'obspgb_configuration_overlay_input', $input_html, $args, $section_data );
