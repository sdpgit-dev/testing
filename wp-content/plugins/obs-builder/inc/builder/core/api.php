...
if ( ! class_exists( 'TTFOBSPGB_Sections' ) ) :
/**
 * Collector for builder sections.
 *
 * @since 1.0.0.
 *
 * Class TTFOBSPGB_Sections
 */
class TTFOBSPGB_Sections {
	/**
	...
	/**
	 * The one instance of TTFOBSPGB_Sections.
	 *
	 * @since 1.0.0.
	 *
	 * @var   TTFOBSPGB_Sections
	 */
	private static $instance;

	/**
	 * Instantiate or return the one TTFOBSPGB_Sections instance.
	 *
	 * @since 1.0.0.
	 *
	 * @return TTFOBSPGB_Sections
	 */
	...
	public function __construct() {
		...
		add_filter( 'obspgb_the_builder_content', 'wpautop' );
	}
	...
	public function add_section( $id, $label, $icon, $description, $save_callback, $builder_template, $display_template, $order, $path, $config = false, $custom = false ) {
		...
		$section = array(
			...
			'order'            => $order,
			'path'             => $path,
			'config'           => ttfobspgb_get_sections_settings( $id ),
		);
		 ...
		 */
		$this->_sections[ $id ] = apply_filters( 'obspgb_add_section', $section );
	}
	...
	public function get_section_defaults() {
		 ...
		 */
		return apply_filters( 'obspgb_sections_defaults', $defaults );
	}
	...
	public function get_choices( $key, $section_type ) {
		 ...
		 */
		return apply_filters( 'obspgb_section_choices', $choices, $key, $section_type );
	}
	...
	public function get_settings( $section_type = false ) {
		 ...
		 */
		$settings = apply_filters( 'obspgb_sections_settings', array() );
		...
		foreach ( $settings as $_section_type => $section_settings ) {
			 ...
			 */
			$section_settings = apply_filters( 'obspgb_section_settings', $section_settings, $_section_type );
	...
	public function the_builder_content( $content ) {
		 ...
		 */
		$content = apply_filters( 'ttfobspgb_the_builder_content', $content );
		 ...
		 * @param string    $content    The post content.
		 */
		$content = apply_filters( 'obspgb_the_builder_content', $content );
	...
	public function get_next_section_data( $current_section, $sections ) {
		 ...
		 */
		return apply_filters( 'obspgb_get_next_section_data', $next_data, $current_section, $sections );
	}
	...
	public function get_prev_section_data( $current_section, $sections ) {
		 ...
		 * @param array    $sections           The list of all sections.
		 */
		return apply_filters( 'obspgb_get_prev_section_data', $prev_section, $current_section, $sections );
	}
	...
	public function section_html_id( $current_section ) {
		 ...
		 */
		return apply_filters( 'obspgb_section_html_id', $prefix . $id, $current_section );
	}
	...
	public function section_html_classes( $current_section, $sections ) {
		 ...
		 */
		$html_classes = apply_filters( 'obspgb_section_classes', $html_classes, $current_section );
	...
	public function section_html_style( $current_section ) {
		...
		if ( isset( $current_section['background-image'] ) && 0 !== absint( $current_section['background-image'] ) ) {
			$image_src = ttfobspgb_get_image_src( $current_section['background-image'], 'full' );
...
if ( ! function_exists( 'ttfobspgb_get_sections_class' ) ) :
/**
 * Instantiate or return the one TTFOBSPGB_Sections instance.
 *
 * @since 1.0.0.
 ...
 * @return TTFOBSPGB_Sections
 */
function ttfobspgb_get_sections_class() {
	return TTFOBSPGB_Sections::instance();
}
endif;

if ( ! function_exists( 'ttfobspgb_get_sections' ) ) :
/**
 ...
 */
function ttfobspgb_get_sections() {
	return ttfobspgb_get_sections_class()->get_sections();
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_definition' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_definition( $section_type ) {
...
if ( ! function_exists( 'ttfobspgb_get_sections_by_order' ) ) :
/**
 ...
 */
function ttfobspgb_get_sections_by_order() {
	$sections = ttfobspgb_get_sections_class()->get_sections();
	usort( $sections, 'ttfobspgb_sorter' );
	return $sections;
}
endif;

if ( ! function_exists( 'ttfobspgb_sorter' ) ) :
/**
 ...
 */
function ttfobspgb_sorter( $a, $b ) {
	return $a['order'] - $b['order'];
}
endif;

if ( ! function_exists( 'ttfobspgb_add_section' ) ) :
/**
 * Add a section.
 *
 * @since 1.0.0.
 ...
 * @return void
 */
function ttfobspgb_add_section( $id, $label, $icon, $description, $save_callback, $builder_template, $display_template, $order, $path, $config = false, $custom = false ) {
	ttfobspgb_get_sections_class()->add_section( $id, $label, $icon, $description, $save_callback, $builder_template, $display_template, $order, $path, $config, $custom );
}
endif;

if ( ! function_exists( 'ttfobspgb_remove_section' ) ) :
/**
 ...
 * @return void
 */
function ttfobspgb_remove_section( $id ) {
	ttfobspgb_get_sections_class()->remove_section( $id );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_sections_defaults' ) ) :
/**
 ...
 */
function ttfobspgb_get_sections_defaults() {
	return ttfobspgb_get_sections_class()->get_section_defaults();
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_defaults' ) ) :
/**
 * Return the default value for a particular section setting.
 *
 * @since 1.0.0.
 ...
 * @return mixed 	Default sections values.
 */
function ttfobspgb_get_section_defaults( $section_type ) {
	$defaults = ttfobspgb_get_sections_defaults();
...
if ( ! function_exists( 'ttfobspgb_get_section_default' ) ) :
/**
 * Return the default value for a particular section setting.
 *
 * @since 1.0.0.
 ...
 */
function ttfobspgb_get_section_default( $key, $section_type ) {
	$defaults = ttfobspgb_get_sections_defaults();
	$value = false;
	 ...
	 * @param string    $section_type    The type of section the data is for.
	 */
	return apply_filters( 'obspgb_get_section_default', $value, $key, $section_type );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_choices' ) ) :
/**
 * Wrapper function for TTFOBSPGB_Section_Definitions->get_choices
 *
 * @since 1.0.0.
 *
 * @param  string    $key             The key for the section setting.
 ...
 * @return array                      The array of choices for the section setting.
 */
function ttfobspgb_get_section_choices( $key, $section_type ) {
	return ttfobspgb_get_sections_class()->get_choices( $key, $section_type );
}
endif;

if ( ! function_exists( 'ttfobspgb_sanitize_section_choice' ) ) :
/**
 ...
 */
function ttfobspgb_sanitize_section_choice( $value, $key, $section_type ) {
	$choices         = ttfobspgb_get_section_choices( $key, $section_type );
	$allowed_choices = array_keys( $choices );

	if ( ! in_array( $value, $allowed_choices ) ) {
		$value = ttfobspgb_get_section_default( $key, $section_type );
	}
	 ...
	 * @param string    $section_type    The section type.
	 */
	return apply_filters( 'obspgb_sanitize_section_choice', $value, $key, $section_type );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_settings' ) ) :
/**
 * Return the default value for a particular section setting.
 *
 * @since 1.0.0.
 ...
 * @return mixed                      Default value if found; false if not found.
 */
function ttfobspgb_get_sections_settings( $section_type = false ) {
	$settings = ttfobspgb_get_sections_class()->get_settings( $section_type );
	return $settings;
}
endif;

if ( ! function_exists( 'ttfobspgb_get_template' ) ) :
/**
 ...
 * @return void
 */
function ttfobspgb_get_template( $slug, $name = '' ) {
	$templates = array();
	$paths = array(
		obspgb_get_plugin_directory() . '/inc/',
		get_stylesheet_directory() . '/obspgb-builder/',
	);
	$slug = ltrim( $slug, '/' );
	...
	foreach ( $templates as $template ) {
		foreach( $paths as $path ) {
			 ...
			 */
			$template_file = apply_filters( 'obspgb_load_section_template', $template_file, $slug, $name );
...
if ( ! function_exists( 'ttfobspgb_get_section_data' ) ) :
/**
 * MISSING DOCS
 *
 */
function ttfobspgb_get_section_data() {
	global $ttfobspgb_section_data;

	return $ttfobspgb_section_data;
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_field' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_field( $field ) {
	global $ttfobspgb_section_data;

	$value = ttfobspgb_get_section_default( $field, $ttfobspgb_section_data['section-type'] );
	$value = false !== $value && $value || '';

	if ( isset( $ttfobspgb_section_data[$field] ) ) {
		$value = $ttfobspgb_section_data[$field];
	}
...
if ( ! function_exists( 'ttfobspgb_get_content' ) ) :
/**
 ...
 */
function ttfobspgb_get_content( $content ) {
	return ttfobspgb_get_sections_class()->the_builder_content( $content );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_image' ) ) :
/**
 ...
 */
function ttfobspgb_get_image( $image_id, $size ) {
	$return = '';

	if ( false === strpos( $image_id, 'x' ) ) {
		$return = wp_get_attachment_image( $image_id, $size );
	} else {
		$image = ttfobspgb_get_placeholder_image( $image_id );
	 ...
	 */
	return apply_filters( 'obspgb_get_image', $return, $image_id, $size );
}
endif;

global $ttfobspgb_placeholder_images;

if ( ! function_exists( 'ttfobspgb_get_placeholder_image' ) ) :
/**
 ...
 */
function ttfobspgb_get_placeholder_image( $image_id ) {
	global $ttfobspgb_placeholder_images;
	$return = array();

	if ( isset( $ttfobspgb_placeholder_images[ $image_id ] ) ) {
		$return = $ttfobspgb_placeholder_images[ $image_id ];
	}
	 ...
	 * @param int       $image_id                      The ID for the image.
	 * @param bool      $ttfobspgb_placeholder_images    The list of placeholder images.
	 */
	return apply_filters( 'obspgb_get_placeholder_image', $return, $image_id, $ttfobspgb_placeholder_images );
}
endif;

if ( ! function_exists( 'ttfobspgb_register_placeholder_image' ) ) :
/**
 ...
 * @return void
 */
function ttfobspgb_register_placeholder_image( $id, $data ) {
	global $ttfobspgb_placeholder_images;
	$ttfobspgb_placeholder_images[ $id ] = $data;
}
endif;

if ( ! function_exists( 'ttfobspgb_get_image_src' ) ) :
/**
 * Get an image's src.
 *
 * @since 1.0.0.
 ...
 */
function ttfobspgb_get_image_src( $image_id, $size ) {
	$src = '';
	 ...
	 * @param bool      $size        The requested image size.
	 */
	return apply_filters( 'obspgb_get_image_src', $src, $image_id, $size );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_html_id' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_html_id() {
	global $ttfobspgb_section_data;

	return ttfobspgb_get_sections_class()->section_html_id( $ttfobspgb_section_data );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_html_class' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_html_class() {
	global $ttfobspgb_section_data, $ttfobspgb_sections;
	$classes = ttfobspgb_get_sections_class()->section_html_classes( $ttfobspgb_section_data, $ttfobspgb_sections );
	 ...
	 * @param array    $ttfobspgb_section_data    The data of the current section.
	 * @param array    $ttfobspgb_sections        A list of sections in the current layout.
	 *
 	 * @return string                           The filtered HTML class.
	 */
	return apply_filters( 'obspgb_section_html_class', $classes, $ttfobspgb_section_data, $ttfobspgb_sections );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_html_style' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_html_style() {
	global $ttfobspgb_section_data, $ttfobspgb_sections;
	$style = ttfobspgb_get_sections_class()->section_html_style( $ttfobspgb_section_data );
	 ...
	 */
	return apply_filters( 'obspgb_section_html_style', $style, $ttfobspgb_section_data, $ttfobspgb_sections );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_item_html_class' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_item_html_class( $item_data ) {
	global $ttfobspgb_section_data;
	$classes = '';
	 ...
	 *
 	 * @return string                           The filtered HTML class.
	 */
	$classes = apply_filters( 'obspgb_section_item_html_class', $classes, $item_data, $ttfobspgb_section_data );
	$classes = implode( ' ', array_map( 'sanitize_html_class', explode( ' ', $classes ) ) );
...
if ( ! function_exists( 'ttfobspgb_get_section_item_html_style' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_item_html_style( $item_data ) {
	global $ttfobspgb_section_data;
	$style = '';
	 ...
	 *
 	 * @return string                           The filtered HTML style.
	 */
	return apply_filters( 'obspgb_section_item_html_style', $style, $item_data, $ttfobspgb_section_data );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_item_html_attrs' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_item_html_attrs( $item_data ) {
	global $ttfobspgb_section_data;
	$attrs = '';
	 ...
	 */
	return apply_filters( 'obspgb_section_item_html_attrs', $attrs, $item_data, $ttfobspgb_section_data );
}
endif;

if ( ! function_exists( 'ttfobspgb_should_render_section' ) ) :
/**
 ...
 */
function ttfobspgb_should_render_section( $section_data ) {
	/**
	 ...
	 */
	return apply_filters( 'obspgb_should_render_section', true, $section_data );
}
endif;

if ( ! function_exists( 'ttfobspgb_get_section_html_attrs' ) ) :
/**
 ...
 */
function ttfobspgb_get_section_html_attrs() {
	global $ttfobspgb_section_data, $ttfobspgb_sections;
	$attrs = '';
	 ...
	 */
	return apply_filters( 'obspgb_section_html_attrs', $attrs, $ttfobspgb_section_data );
}
endif;

if ( ! function_exists( 'ttfobspgb_sanitize_image_id' ) ) :
/**
 ...
 */
function ttfobspgb_sanitize_image_id( $id ) {
