/* global jQuery, _, ObspgbFormatBuilder, ObspgbIconPicker */
	...
	builder = $.extend(builder, {
		...
		open: function( editor ) {
			...
			args = {
				...
				onclose: function() {
					...
					builder.editor.execCommand('Obspgb_Reset_Dynamic_Stylesheet');
		...
		getFormatListBox: function() {
			var listbox = {
				type: 'listbox',
				name: 'format',
				id: 'ttfobspgb-format-builder-picker',
				minWidth: 300,
		...
		getInsertButton: function() {
			var button = {
				...
				id: 'ttfobspgb-format-builder-insert',
				name: 'formatSubmit',
		...
		getRemoveButton: function() {
			var button = {
				text: 'Remove',
				id: 'ttfobspgb-format-builder-remove',
				name: 'formatRemove',
...
})(jQuery, _, ObspgbFormatBuilder, ObspgbIconPicker);