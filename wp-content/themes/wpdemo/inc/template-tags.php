...
if ( ! function_exists( 'wpdemo_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function wpdemo_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'wpdemo_entry_footer' ) ) :
	...
	function wpdemo_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'wpdemo' ) );
			if ( $tags_list ) {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'wpdemo' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'wpdemo' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'wpdemo_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function wpdemo_post_thumbnail() {
